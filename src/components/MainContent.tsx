...
import { CheckCircle, Circle, CaretLeft, CaretRight, ArrowLeft, Check } from '@phosphor-icons/react'
  ...
  return (
    <div className="flex-1 flex relative">
      ...
      <div className={cn(
        ...
        iframeExpanded ? "w-[50%] opacity-100" : "w-0 opacity-0 overflow-hidden"
      )}>
        {iframeExpanded && (
